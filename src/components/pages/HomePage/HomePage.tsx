      ...
      <PageSection>
        <section className="my-8 sm:text-lg leading-8">
          <p>
            ...
            building polished, impactful, and innovative products. My journey
            into programming began in 2022-2023
            <UnhideButton>
            ...
            and DevOps, transforming me into a well-rounded full-stack
            developer.
            <strong>
              <em>
                {" "}
          ...
          <p className="mt-4">
            ...
            I’ve spent countless hours building personal projects, contributing
            to open-source, and immersing myself in the developer community.{" "}
            <UnhideButton>
